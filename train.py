...
def main():
    ...
    model = hico.builder.HiCo(opts.encoder_args,args.moco_dim,args.moco_k,args.moco_m,args.moco_t)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 50 == 0:
                  ...
                  }, is_best=False, filename=args.checkpoint_path+'/checkpoint_{:04d}_loss_{:.3f}_acc_{:.3f}.pth.tar'.format(epoch,loss.avg,acc1.avg))
